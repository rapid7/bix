    ...
    styles: function styles(component) {
        ...
        if ((0, _isObject2.default)(component)) {
            ...
            var _ret = function () {
                ...
                if ((0, _isUndefined2.default)(_this.$$components[name])) {
                    _this.$$components[name] = {};
                }

                _this.$$components[name].component = component;

                if ((0, _isUndefined2.default)(_this.$$components[name].styles)) {
                    _this.$$components[name].styles = {};
                }

                _styles.forEach(function (style) {
                    _this.$$components[name].styles = (0, _combine2.default)(_this.$$components[name].styles, style);
                });
            }();
    ...
    stylesheet: function stylesheet(id) {
        ...
        if ((0, _utils.hasDocument)()) {
            ...
            var _ret2 = function () {
                ...
                if (!(0, _isUndefined2.default)(_this2.$$stylesheets[id])) {
